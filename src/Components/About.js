      ...
      <div className="know_me">
        ...
        <Element name="About">
            ...
            <p id="sub_heading" data-aos="fade-up">
              Hi Everyone, I am <span className="about_span">Rocky</span>{" "}
              from <span className="about_span">USA</span>.
            </p>
        </Element>
          </div>
        <div className="full_detail" data-aos="fade-left">
          I'm a self-taught full stack developer with expertise in HTML, CSS,
          Bootstrap JavaScript, React.js, Npm, Git, Github and much more. Currently, I'm
